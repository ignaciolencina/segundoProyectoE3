...
const cargarFilaTabla = (pelicula, indice) => {
  ...
  $btnPublicar.classList.add(
    "btn",
    "btn-sm",
    pelicula.publicada ? "btn-success" : "btn-secondary"
  );
  ...
  $iconoEstrella.classList.add(
    "fa",
    pelicula.destacar ? "fa-star" : "fa-star-o"
  );
...
const togglePublicarPelicula = (codigo, $btnPublicar) => {
  ...
  if (pelicula) {
    ...
    $btnPublicar.textContent = pelicula.publicada
      ? "Publicado"
      : "No Publicado";
  }
};
